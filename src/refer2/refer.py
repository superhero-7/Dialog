...
class REFER:
	...
	def __init__(self, data_root, dataset='refcoco', splitBy='unc'):
		...
		logger.info('loading dataset {} into memory...'.format(dataset))
		...
		# 	sys.exit()
		self.IMAGE_DIR = '/workspace/yfl/datasets/train2014'
		...
		logger.info('DONE(t={}s)'.format(time.time()-tic))
