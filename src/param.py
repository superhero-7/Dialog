...
def parse_args(parse=True, **optional_kwargs):
    ...
    #  这个在refcoco的dataset里面有，但原来都没这个参数
    parser.add_argument('--vis_pointer', default=False)
    ...
    parser.add_argument('--refcoco_dir', type=str, default='/workspace/yfl/codebase/VL-T5/datasets/RefCOCO')
