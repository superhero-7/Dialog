...
# 诶，这个我会hhhh贼好用，可以用来打印log的！
logger = logging.get_logger(__name__)

# 这个visualEmbedding就是用来返回图像输入的：
...
class VisualEmbedding(nn.Module):
    ...
    def forward(self, feats, pos, img_order_ids=None, obj_order_ids=None):
        ...
        if self.config.use_vis_order_embedding:
            ...
            # 注意到他们这个地方obj_order_ids是跟text共用vocabulary的！
...
# T5Stack是干什么用的？这个JointEncoder又是作甚么？
# T5Stack其实就是用来包encoder，decoder的；
