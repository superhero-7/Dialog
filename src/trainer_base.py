...
class TrainerBase(object):
    def __init__(self, args, train_loader=None, val_loader=None, test_loader=None, train=True):
        ...
        #self.test_loaderB = test_loaderB
...
class TrainerBase2(object):
    def __init__(self, args, train_loader=None, val_loader=None, test_loaderA=None, test_loaderB=None, train=True):
        self.args = args

        self.train_loader = train_loader
        self.val_loader = val_loader
        self.test_loaderA = test_loaderA
        self.test_loaderB = test_loaderB
